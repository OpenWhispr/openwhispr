...
function useSettingsInternal() {
  ...
  return {
    ...
    duckAudioOnDictation: store.duckAudioOnDictation,
    setDuckAudioOnDictation: store.setDuckAudioOnDictation,
    duckVolumeLevel: store.duckVolumeLevel,
    setDuckVolumeLevel: store.setDuckVolumeLevel,
