...
function useSettingsInternal() {
  ...
  return {
    ...
    notifyTranscriptionStatus: store.notifyTranscriptionStatus,
    setNotifyTranscriptionStatus: store.setNotifyTranscriptionStatus,
    notifyModelDownloads: store.notifyModelDownloads,
    setNotifyModelDownloads: store.setNotifyModelDownloads,
    notifyClipboardOperations: store.notifyClipboardOperations,
    setNotifyClipboardOperations: store.setNotifyClipboardOperations,
