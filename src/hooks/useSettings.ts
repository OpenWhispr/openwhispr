...
function useSettingsInternal() {
  ...
  return {
    ...
    notchPopupEnabled: store.notchPopupEnabled,
    setNotchPopupEnabled: store.setNotchPopupEnabled,
    notchPopupExpanded: store.notchPopupExpanded,
    setNotchPopupExpanded: store.setNotchPopupExpanded,
    notchPopupPanelSize: store.notchPopupPanelSize,
    setNotchPopupPanelSize: store.setNotchPopupPanelSize,
