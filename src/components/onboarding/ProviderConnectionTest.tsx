      ...
      <div>
        <div className="flex h-11 items-center justify-between rounded-xl border border-[var(--onboarding-control-border)] bg-[var(--onboarding-surface)] px-3">
          ...
          <Button
            ...
            className="bg-none hover:brightness-100 h-7 gap-1 rounded-full border-[var(--onboarding-inverse-surface)]! bg-[var(--onboarding-inverse-surface)] px-2 text-[0.5625rem] font-normal text-[var(--onboarding-inverse-text)] shadow-none! hover:bg-[var(--onboarding-inverse-surface-secondary)] focus-visible:ring-0 disabled:opacity-70"
          >
