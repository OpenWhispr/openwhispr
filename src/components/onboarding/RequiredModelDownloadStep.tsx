            ...
            >
              ...
              {isDownloading ? (
                ...
                <Button
                  ...
                  className="bg-none hover:brightness-100 -me-2 h-7 gap-1.5 rounded-full border-0! bg-[var(--onboarding-accent)] px-2.5 text-xs font-normal text-[var(--onboarding-accent-foreground)] shadow-none! hover:bg-[var(--onboarding-accent-hover)] hover:shadow-none!"
                >
                  {t("common.retry")}
                </Button>
              ) : installed ? (
