...
export default function ChatAgentSettings() {
  ...
  const chatAgentEnabled = useSettingsStore((s) => s.chatAgentEnabled);
  const setChatAgentEnabled = useSettingsStore((s) => s.setChatAgentEnabled);
    ...
    <div className="space-y-6">
      <SettingsPanel>
        <SettingsPanelRow>
          ...
          >
            <Toggle checked={chatAgentEnabled} onChange={setChatAgentEnabled} />
          </SettingsRow>
        </SettingsPanelRow>
      </SettingsPanel>
