...
A trusted cold/warm creator link is retained for the current account. The existing early paywall screen offers normal text-field paste through “Have a creator link?”. Continue validates the link; empty input continues normally, and failure retains input for retry or clearing. Plans & Billing offers recovery before a first personal purchase. There is no automatic clipboard reading or client-side commission reporting.
