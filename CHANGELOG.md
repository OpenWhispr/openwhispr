...
- **No more post-meeting card.** When a meeting recording stops on its own, the 30-second **Restart recording** card and its fallback toasts no longer appear. The recording still stops and the transcript is saved, and the note offers **Generate AI Summary** as before. The card's main-process, overlay, preload and translation code has been removed with it. (#2192, #2197)
