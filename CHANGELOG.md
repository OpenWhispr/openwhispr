...
* **account:** Isolate account deletion from device data ([#1812](https://github.com/PlaybookMediaLLC/openwhispr/issues/1812)) ([fb7496e](https://github.com/PlaybookMediaLLC/openwhispr/commit/fb7496e137038c01fee90ccfa8c0a98959211f84))
* **ai:** retry HTTP 408 request timeouts in the API retry strategy ([#1734](https://github.com/PlaybookMediaLLC/openwhispr/issues/1734)) ([d3661cb](https://github.com/PlaybookMediaLLC/openwhispr/commit/d3661cb0c5d15f4f474395fd30a085b93b74544f))
* **auth:** check existing emails before sign-up ([#1854](https://github.com/PlaybookMediaLLC/openwhispr/issues/1854)) ([ada9efb](https://github.com/PlaybookMediaLLC/openwhispr/commit/ada9efb3f164c52f03b895ccfe88c8c346e630b7))
* **auth:** Unify onboarding and reauthentication display ([#1763](https://github.com/PlaybookMediaLLC/openwhispr/issues/1763)) ([3cc197f](https://github.com/PlaybookMediaLLC/openwhispr/commit/3cc197ff3b91a4c6c74f979af3dcbca011e68bda))
* **branding:** show the distribution mark in onboarding, and boot the cloud extension ([20128cc](https://github.com/PlaybookMediaLLC/openwhispr/commit/20128cc37f510c95083eba9b763875abe5ac3873))
* **calendar:** fail OAuth loopback immediately on state mismatch ([#1753](https://github.com/PlaybookMediaLLC/openwhispr/issues/1753)) ([8b77a59](https://github.com/PlaybookMediaLLC/openwhispr/commit/8b77a599ce91172e421ca0cd4f8bd5fd3cbae47f))
...
* **calendar:** resolve Microsoft series masters through their calendar ([#1835](https://github.com/PlaybookMediaLLC/openwhispr/issues/1835)) ([a0bbf4f](https://github.com/PlaybookMediaLLC/openwhispr/commit/a0bbf4f9927acdafe0a77c3b24c983c9becd8591))
* **chat:** persist conversation migration links ([#1772](https://github.com/PlaybookMediaLLC/openwhispr/issues/1772)) ([15b5b3f](https://github.com/PlaybookMediaLLC/openwhispr/commit/15b5b3fd87e61ba059d033c4592fb4909e37af65))
* **ci:** stop the two tests jobs from sharing a name and disagreeing ([#1745](https://github.com/PlaybookMediaLLC/openwhispr/issues/1745)) ([43b30fb](https://github.com/PlaybookMediaLLC/openwhispr/commit/43b30fbe0ff531fa0919a6b9892019de996ce0ef))
* **cleanup:** pass temperature 0 on the dictation-cleanup route ([#2007](https://github.com/PlaybookMediaLLC/openwhispr/issues/2007)) ([a9cf27b](https://github.com/PlaybookMediaLLC/openwhispr/commit/a9cf27b49bdcc9069922641ec39ac06d3483a125)), closes [#1073](https://github.com/PlaybookMediaLLC/openwhispr/issues/1073) [#1714](https://github.com/PlaybookMediaLLC/openwhispr/issues/1714)
...
* **cli:** enforce request body byte limit ([#1777](https://github.com/PlaybookMediaLLC/openwhispr/issues/1777)) ([996fe79](https://github.com/PlaybookMediaLLC/openwhispr/commit/996fe79b78846f9b1504c8f629257c7a33779add))
* **clipboard:** preserve dictation history when clipboard delivery fails ([#1979](https://github.com/PlaybookMediaLLC/openwhispr/issues/1979)) ([f03e027](https://github.com/PlaybookMediaLLC/openwhispr/commit/f03e027e9104a5620039ff099336ec29e1b0897d))
* **cli:** preserve UTF-8 request bodies ([#1386](https://github.com/PlaybookMediaLLC/openwhispr/issues/1386)) ([ef627c9](https://github.com/PlaybookMediaLLC/openwhispr/commit/ef627c967f6cefe2ec391f176fffc758c7a35de1))
* **debug-log:** Include app version in System Info header ([#1688](https://github.com/PlaybookMediaLLC/openwhispr/issues/1688)) ([edc98c5](https://github.com/PlaybookMediaLLC/openwhispr/commit/edc98c50e55743b311910785ee3b15833ddfc3aa))
...
* **dictation:** skip the dictionary-echo check when the provider never got the dictionary ([#1929](https://github.com/PlaybookMediaLLC/openwhispr/issues/1929)) ([4d28a19](https://github.com/PlaybookMediaLLC/openwhispr/commit/4d28a19b7f2e1da39ee85c69dc0b87d490192824))
* **dictation:** stop blocking the recording start on the cloud STT config ([#1710](https://github.com/PlaybookMediaLLC/openwhispr/issues/1710)) ([42a5b68](https://github.com/PlaybookMediaLLC/openwhispr/commit/42a5b68c4b7b36f12ffdc226d6be2ef43f146aa8))
...
* **enterprise:** harden AWS Bedrock error handling ([#1981](https://github.com/PlaybookMediaLLC/openwhispr/issues/1981)) ([fdded86](https://github.com/PlaybookMediaLLC/openwhispr/commit/fdded860bb944c3c64503f92c5dceb7f1ab8f6e6))
* **gpu:** refresh banner after settings close ([#1804](https://github.com/PlaybookMediaLLC/openwhispr/issues/1804)) ([6619b50](https://github.com/PlaybookMediaLLC/openwhispr/commit/6619b5004b7ed78562d44f0de12462fbd1642e46))
...
* **hyprland:** clean up binds left by a previous distribution namespace ([4aa9398](https://github.com/PlaybookMediaLLC/openwhispr/commit/4aa9398f3a3985567c9873c3d64998c25c71a72d))
* **i18n:** guard localStorage deref against partial window stubs ([#1842](https://github.com/PlaybookMediaLLC/openwhispr/issues/1842)) ([0686a26](https://github.com/PlaybookMediaLLC/openwhispr/commit/0686a26942c0047aa6f9ab68417800498bb1235c))
* **linux:** map Hyprland punctuation hotkeys to XKB keysyms ([#1877](https://github.com/PlaybookMediaLLC/openwhispr/issues/1877)) ([db3f8c9](https://github.com/PlaybookMediaLLC/openwhispr/commit/db3f8c930b260afc4b37898a3940fad5df447f63))
* **linux:** map KDE punctuation hotkeys to Qt key codes ([#1752](https://github.com/PlaybookMediaLLC/openwhispr/issues/1752)) ([523acab](https://github.com/PlaybookMediaLLC/openwhispr/commit/523acab0fb2c19423e11167c3077d660d9c2acb3))
...
* **linux:** push-to-talk on Wayland (Hyprland, KDE, GNOME 48+) for dictation hotkey ([#1738](https://github.com/PlaybookMediaLLC/openwhispr/issues/1738)) ([b5c5fb4](https://github.com/PlaybookMediaLLC/openwhispr/commit/b5c5fb44305b65d2fd2d8c17a99cb743228442fb))
...
* **meeting:** handle nullish segments and non-object patches in speakerAssignmentPolicy ([#1798](https://github.com/PlaybookMediaLLC/openwhispr/issues/1798)) ([c519e1f](https://github.com/PlaybookMediaLLC/openwhispr/commit/c519e1f74b5f306e815cd9dae71e2f06667f3b39)), closes [#1797](https://github.com/PlaybookMediaLLC/openwhispr/issues/1797)
* **meetings:** Add swipe dismissal to meeting notifications ([#1906](https://github.com/PlaybookMediaLLC/openwhispr/issues/1906)) ([81f8c71](https://github.com/PlaybookMediaLLC/openwhispr/commit/81f8c71ed2d1abf9dd90dafcd9ae4a6da8432b48)), closes [#1897](https://github.com/PlaybookMediaLLC/openwhispr/issues/1897) [#1904](https://github.com/PlaybookMediaLLC/openwhispr/issues/1904) [#1897](https://github.com/PlaybookMediaLLC/openwhispr/issues/1897)
* **meetings:** Add swipe dismissal to meeting reminders ([#1897](https://github.com/PlaybookMediaLLC/openwhispr/issues/1897)) ([a30bec5](https://github.com/PlaybookMediaLLC/openwhispr/commit/a30bec505a15f249fac82a3a9ee64be5d389eb04))
* **meetings:** capture and diagnose silent system-audio transcription ([#1864](https://github.com/PlaybookMediaLLC/openwhispr/issues/1864)) ([025ae93](https://github.com/PlaybookMediaLLC/openwhispr/commit/025ae934224fdefc06d1dc035b934473b16c6a21)), closes [#630](https://github.com/PlaybookMediaLLC/openwhispr/issues/630)
* **meetings:** fall back to renderer loopback when WASAPI capture is silent ([#1935](https://github.com/PlaybookMediaLLC/openwhispr/issues/1935)) ([db83029](https://github.com/PlaybookMediaLLC/openwhispr/commit/db830298b836247d22868868390157352e25ceee)), closes [#1891](https://github.com/PlaybookMediaLLC/openwhispr/issues/1891)
* **meetings:** restore meeting prompts for later calls ([#1918](https://github.com/PlaybookMediaLLC/openwhispr/issues/1918)) ([396b401](https://github.com/PlaybookMediaLLC/openwhispr/commit/396b401564826e771dd6594b1053e2c6067e0714))
...
* **network:** treat the full IPv6 link-local range as private HTTP ([#1733](https://github.com/PlaybookMediaLLC/openwhispr/issues/1733)) ([1fe91f2](https://github.com/PlaybookMediaLLC/openwhispr/commit/1fe91f215832c475ae99873f36c6708f909301f0))
...
* **notes:** format future timestamps as dates ([#1768](https://github.com/PlaybookMediaLLC/openwhispr/issues/1768)) ([5d5f08c](https://github.com/PlaybookMediaLLC/openwhispr/commit/5d5f08c3bbb59b97066b90cdda008525b041765d))
* **notes:** keep markdown mirror paths inside base ([#1773](https://github.com/PlaybookMediaLLC/openwhispr/issues/1773)) ([2893be4](https://github.com/PlaybookMediaLLC/openwhispr/commit/2893be42a54844e1fba23100847ffe89231870a8))
* **notes:** keep note content visible above the floating chat panel ([#1769](https://github.com/PlaybookMediaLLC/openwhispr/issues/1769)) ([fa11ddc](https://github.com/PlaybookMediaLLC/openwhispr/commit/fa11ddc9040c4f26c689398138f390d8af8ef2cd))
* **notes:** preserve transcript scroll during resize ([#1896](https://github.com/PlaybookMediaLLC/openwhispr/issues/1896)) ([a321d93](https://github.com/PlaybookMediaLLC/openwhispr/commit/a321d9369efc0b6ff78fa063bc78a04939144029))
* **notes:** prevent clientNoteId collisions on Granola CSV imports sharing title and date ([#1954](https://github.com/PlaybookMediaLLC/openwhispr/issues/1954)) ([#1955](https://github.com/PlaybookMediaLLC/openwhispr/issues/1955)) ([c73e302](https://github.com/PlaybookMediaLLC/openwhispr/commit/c73e3027b397728fd0ce25e056764cc54edb3c23))
...
* **paste:** skip trailing space after CJK text in append smart spacing ([#1823](https://github.com/PlaybookMediaLLC/openwhispr/issues/1823)) ([f26b059](https://github.com/PlaybookMediaLLC/openwhispr/commit/f26b0595d2470036823c1dcddab7693b7ef9b610))
* **perf:** eliminate recording-time CPU regressions and heal GPU-pack fallout ([#1863](https://github.com/PlaybookMediaLLC/openwhispr/issues/1863)) ([600d65a](https://github.com/PlaybookMediaLLC/openwhispr/commit/600d65af0deda6af42a3c3cd127fb7806d69db50)), closes [#1458](https://github.com/PlaybookMediaLLC/openwhispr/issues/1458)
* **reasoning:** guard Anthropic response text extraction against non-text content ([#1709](https://github.com/PlaybookMediaLLC/openwhispr/issues/1709)) ([84dd790](https://github.com/PlaybookMediaLLC/openwhispr/commit/84dd7902b6ab178ec76d5e71746d693c8a923383))
* **reasoning:** make streaming think filter case-insensitive and drop orphan closers ([#1861](https://github.com/PlaybookMediaLLC/openwhispr/issues/1861)) ([#1862](https://github.com/PlaybookMediaLLC/openwhispr/issues/1862)) ([14ef874](https://github.com/PlaybookMediaLLC/openwhispr/commit/14ef874e5f50dfb67e0ba8b6dcad6ca1c83c7d3f))
* **reasoning:** make stripThinkingTags case-insensitive and clean stray closing tags ([#1801](https://github.com/PlaybookMediaLLC/openwhispr/issues/1801)) ([#1802](https://github.com/PlaybookMediaLLC/openwhispr/issues/1802)) ([909ee58](https://github.com/PlaybookMediaLLC/openwhispr/commit/909ee586b04f10d765d61b2f2dd23546a2819f7b))
* **release:** gate on the status check the Tests workflow still reports ([081d282](https://github.com/PlaybookMediaLLC/openwhispr/commit/081d28209d3e022614d072f1568abce20cb6a845))
...
* **settings:** keep the settings modal open when a dropdown is dismissed ([#1820](https://github.com/PlaybookMediaLLC/openwhispr/issues/1820)) ([345b75d](https://github.com/PlaybookMediaLLC/openwhispr/commit/345b75d913fab90d879072f7ba02d4ad01c4933a))
...
* **stores:** Survive imports under partial browser window stubs ([#1841](https://github.com/PlaybookMediaLLC/openwhispr/issues/1841)) ([b934b88](https://github.com/PlaybookMediaLLC/openwhispr/commit/b934b889cfb46d91e21bce5333360ea3f9d44d16))
* support copying Assistant response selections ([#2035](https://github.com/PlaybookMediaLLC/openwhispr/issues/2035)) ([2292499](https://github.com/PlaybookMediaLLC/openwhispr/commit/22924997c0bb019221f5ccb3f37188544e23059f))
* **sync:** let the server stamp updated_at on note creates ([#2065](https://github.com/PlaybookMediaLLC/openwhispr/issues/2065)) ([d0039ba](https://github.com/PlaybookMediaLLC/openwhispr/commit/d0039ba06d8dd836c54bae8d4c7afc3b1c80115b))
* **tinfoil:** move the default chat model from glm-5-2 to glm-5-3 ([#2018](https://github.com/PlaybookMediaLLC/openwhispr/issues/2018)) ([9e86381](https://github.com/PlaybookMediaLLC/openwhispr/commit/9e86381d456ff582204a0106f1ba9854533a9a70)), closes [#1722](https://github.com/PlaybookMediaLLC/openwhispr/issues/1722)
* **transcription:** give the model-registry JSON import its type attribute ([#1933](https://github.com/PlaybookMediaLLC/openwhispr/issues/1933)) ([ca97c0b](https://github.com/PlaybookMediaLLC/openwhispr/commit/ca97c0b1a18750d5dfbc5a02e7e9f5a68e416367)), closes [#1836](https://github.com/PlaybookMediaLLC/openwhispr/issues/1836) [#1908](https://github.com/PlaybookMediaLLC/openwhispr/issues/1908)
* **transcription:** harden dictionary prompt recovery ([#1960](https://github.com/PlaybookMediaLLC/openwhispr/issues/1960)) ([abfaf2b](https://github.com/PlaybookMediaLLC/openwhispr/commit/abfaf2ba010a7a122a70eb7ec4541324eebaf33d)), closes [#1889](https://github.com/PlaybookMediaLLC/openwhispr/issues/1889)
* **upload:** Clarify model and speaker detection failures ([#1991](https://github.com/PlaybookMediaLLC/openwhispr/issues/1991)) ([a4c914c](https://github.com/PlaybookMediaLLC/openwhispr/commit/a4c914c91a18dbc021776311b67150ee4faa5555))
...
* **uploads:** normalize provider names and clamp verbose segment timestamps ([#1800](https://github.com/PlaybookMediaLLC/openwhispr/issues/1800)) ([d9499f5](https://github.com/PlaybookMediaLLC/openwhispr/commit/d9499f59ffd9a1e0f19b278ff10736ea64fc351c)), closes [#1799](https://github.com/PlaybookMediaLLC/openwhispr/issues/1799)
* **utils:** handle nullish and invalid inputs safely in date formatting ([#1783](https://github.com/PlaybookMediaLLC/openwhispr/issues/1783)) ([#1784](https://github.com/PlaybookMediaLLC/openwhispr/issues/1784)) ([858e824](https://github.com/PlaybookMediaLLC/openwhispr/commit/858e82408789f40a787d3a255a96df088d065cad))
...
* **whisper:** extract MSVC runtime DLLs beside win32 whisper-server ([#1687](https://github.com/PlaybookMediaLLC/openwhispr/issues/1687)) ([fad475c](https://github.com/PlaybookMediaLLC/openwhispr/commit/fad475c6f4e756db08fe0f0eec7d9f4bdf149160))
...
* **windows:** block untrusted file navigation ([#1776](https://github.com/PlaybookMediaLLC/openwhispr/issues/1776)) ([45c20b8](https://github.com/PlaybookMediaLLC/openwhispr/commit/45c20b809c2907dbe5a290a9ee8d80f8d0c5e8cd))
* **windows:** only hand explorer.exe URLs it can actually deliver ([#1932](https://github.com/PlaybookMediaLLC/openwhispr/issues/1932)) ([532a3cf](https://github.com/PlaybookMediaLLC/openwhispr/commit/532a3cf77b0ca7fef9e82da5f1665d27b0d4e237)), closes [microsoft/WSL#3832](https://github.com/microsoft/WSL/issues/3832) [neovim#23401](https://github.com/neovim/issues/23401) [rauschma/openurl#2](https://github.com/rauschma/openurl/issues/2)
...
* add unified analytics insights ([#1959](https://github.com/PlaybookMediaLLC/openwhispr/issues/1959)) ([c749d6e](https://github.com/PlaybookMediaLLC/openwhispr/commit/c749d6e1ea59fe70cb90ac484390c5e274d574fa)), closes [#180](https://github.com/PlaybookMediaLLC/openwhispr/issues/180) [#180](https://github.com/PlaybookMediaLLC/openwhispr/issues/180) [#180](https://github.com/PlaybookMediaLLC/openwhispr/issues/180)
* **billing:** self-serve Enterprise upgrade + admin console entry ([#1623](https://github.com/PlaybookMediaLLC/openwhispr/issues/1623)) ([e039861](https://github.com/PlaybookMediaLLC/openwhispr/commit/e039861115491b3d7c7e61c30d07ea66c2606d15))
* **branding:** use the real Oppulence mark for Oppulence Voice ([f4c1ea2](https://github.com/PlaybookMediaLLC/openwhispr/commit/f4c1ea2f401d47cf3c25291f57bfb3ab995f418d))
* **calendar:** add provider-neutral availability tool ([#1821](https://github.com/PlaybookMediaLLC/openwhispr/issues/1821)) ([b96f4a2](https://github.com/PlaybookMediaLLC/openwhispr/commit/b96f4a28275c958600295ed4e9c7b4dc35fc0455))
...
* **calendar:** widen the availability horizon from 7 to 31 days ([#1858](https://github.com/PlaybookMediaLLC/openwhispr/issues/1858)) ([4ad61a1](https://github.com/PlaybookMediaLLC/openwhispr/commit/4ad61a18f8fbb01a97db40fc8c901c83079f61eb))
* complete Oppulence Voice cloud integration ([fed389c](https://github.com/PlaybookMediaLLC/openwhispr/commit/fed389c73583a6197ac24fe9b85b3b819853b96d))
* **dictation:** liquid cancel button, pill spacing, and overlay smoothness ([#1886](https://github.com/PlaybookMediaLLC/openwhispr/issues/1886)) ([ba2a641](https://github.com/PlaybookMediaLLC/openwhispr/commit/ba2a6414a9072752b9643b86acbfc8de4120bdff)), closes [#1670](https://github.com/PlaybookMediaLLC/openwhispr/issues/1670) [#1670](https://github.com/PlaybookMediaLLC/openwhispr/issues/1670)
* **dictation:** Signal glow processing state, smooth entrance, pill polish ([#1826](https://github.com/PlaybookMediaLLC/openwhispr/issues/1826)) ([e76ded1](https://github.com/PlaybookMediaLLC/openwhispr/commit/e76ded1625018eb5c627ef0d191f60097a971b4b))
* **hyprland:** support both Lua and legacy configs ([#1664](https://github.com/PlaybookMediaLLC/openwhispr/issues/1664)) ([47da21d](https://github.com/PlaybookMediaLLC/openwhispr/commit/47da21d93221ecf72d6dae2ab4480dd70e714924))
...
* **meetings:** Add immediate auto-end restart window ([#1898](https://github.com/PlaybookMediaLLC/openwhispr/issues/1898)) ([0199d72](https://github.com/PlaybookMediaLLC/openwhispr/commit/0199d72f97e8965ac4f04e18b4d46ebd102ed16e))
...
* **notes:** import Granola meeting notes from CSV export ([#1813](https://github.com/PlaybookMediaLLC/openwhispr/issues/1813)) ([97d5291](https://github.com/PlaybookMediaLLC/openwhispr/commit/97d5291e050d0cefe930f8794f1e73d91e893992))
...
* **onboarding:** add Screen Context permission ([#1856](https://github.com/PlaybookMediaLLC/openwhispr/issues/1856)) ([83622fd](https://github.com/PlaybookMediaLLC/openwhispr/commit/83622fd6eb653eaf16c407198d8495b036656540))
...
* **policy:** Enforce org-required local model downloads ([#1836](https://github.com/PlaybookMediaLLC/openwhispr/issues/1836)) ([409bc28](https://github.com/PlaybookMediaLLC/openwhispr/commit/409bc28d35bad09be1875a164090fb8fb303a089))
...
* **transcription:** add Cohere Transcribe 2B as local STT provider ([#1949](https://github.com/PlaybookMediaLLC/openwhispr/issues/1949)) ([1232188](https://github.com/PlaybookMediaLLC/openwhispr/commit/1232188faf9522a9c38f4a95493513a99f9b6425))
* **transcription:** add Gemini as a BYOK cloud transcription provider ([#1899](https://github.com/PlaybookMediaLLC/openwhispr/issues/1899)) ([ccf837c](https://github.com/PlaybookMediaLLC/openwhispr/commit/ccf837c8fc8dcdbc01d20d5eaafc527cf0d72cbf))
* **transcription:** managed enterprise STT (Azure) via workload identity ([#1964](https://github.com/PlaybookMediaLLC/openwhispr/issues/1964)) ([24e1162](https://github.com/PlaybookMediaLLC/openwhispr/commit/24e1162a41ea268d0c4d958372a052becc3e71ab)), closes [#2036](https://github.com/PlaybookMediaLLC/openwhispr/issues/2036) [#2037](https://github.com/PlaybookMediaLLC/openwhispr/issues/2037) [#2038](https://github.com/PlaybookMediaLLC/openwhispr/issues/2038) [#2056](https://github.com/PlaybookMediaLLC/openwhispr/issues/2056) [#2057](https://github.com/PlaybookMediaLLC/openwhispr/issues/2057)
...
* **ux:** improve GPU Acceleration crash Retry button UX and discovery ([#1913](https://github.com/PlaybookMediaLLC/openwhispr/issues/1913)) ([80021db](https://github.com/PlaybookMediaLLC/openwhispr/commit/80021db8bbcd7bdab8d71c2800e21496888ee39b))
...
* Revert "fix(meetings): Add swipe dismissal to meeting reminders ([#1897](https://github.com/PlaybookMediaLLC/openwhispr/issues/1897))" ([#1904](https://github.com/PlaybookMediaLLC/openwhispr/issues/1904)) ([03e7f21](https://github.com/PlaybookMediaLLC/openwhispr/commit/03e7f2156b50d9a80b4e6cf3e98cc7ae82f199f0))
