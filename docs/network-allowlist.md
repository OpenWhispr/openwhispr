...
| `openrouter.ai`                                                                  | HTTPS      | 443  | OpenRouter selected as a reasoning or transcription provider (`/api/v1/models` is fetched even without a key; the transcription connection test calls `/api/v1/key`).                                                                                                                                                                                    |
