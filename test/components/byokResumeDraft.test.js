...
async function collectByokDrafts(t, { stepId, selfHostedRequested }) {
...
for (const [name, options] of [
  ["a hosted provider", { stepId: "byok-dictation", selfHostedRequested: false }],
  ["a self-hosted endpoint", { stepId: "byok-assistant", selfHostedRequested: true }],
]) {
